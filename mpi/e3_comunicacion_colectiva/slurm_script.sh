#!/bin/bash
#SBATCH --job-name="mpi_e3"              # nombre del trabajo para fácil identificación en la cola de trabajos de Slurm
...
# Ejecutar: asume que el programa ya fue compilado a un ejecutable llamado mpi_e3
srun mpi_e3

#!/bin/bash
#SBATCH --job-name="openmp-e2"              # nombre del trabajo para fácil identificación en la cola de trabajos de Slurm
...
# Ejecutar: asume que el programa ya fue compilado a un ejecutable llamado openmp_e2
srun openmp_e2
